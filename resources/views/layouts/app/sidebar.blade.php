    ...
    <flux:sidebar sticky collapsible="mobile"
        ...
        <flux:sidebar.nav>
            ...
            <flux:sidebar.group :heading="__('Inventory')" class="grid">
                <flux:sidebar.item icon="queue-list" :href="route('items.index')"
                    :current="request()->routeIs('items.index')" wire:navigate>
                    {{ __('Items') }}
                </flux:sidebar.item>
                <flux:sidebar.item icon="building-storefront" :href="route('inventories.index')"
            ...
            <flux:sidebar.group :heading="__('Management')" class="grid">
                <flux:sidebar.item icon="user-circle" :href="route('customers.index')"
